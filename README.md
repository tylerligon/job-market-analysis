...
Title: Data-Driven Skill Matching for Early-Career Tech Jobs
Overview: This project builds a pipeline that filters job postings and matches them to user skills to recommend the most relevant internships and entry-level tech roles.
Features:
